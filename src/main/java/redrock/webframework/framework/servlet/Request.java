package redrock.webframework.framework.servlet;
...
public class Request {
	 ...
	 * @return Request
	 */
	public final static Request build(ChannelHandlerContext ctx, FullHttpRequest nettyRequest) {
